...
#define look_up_sep(sep_path) ({ \
const char \
  *_p = (sep_path); \
const char \
  *_l = _p ? strrchr(_p, _PATH_CHR_SEP_POSIX) : NULL; \
const char \
  *_w = _p ? strrchr(_p, _PATH_CHR_SEP_WIN32) : NULL; \
...
#define DOG_GARBAGE_COMPILER_RETRY (6)
#define DOG_GARBAGE_SELECTION_STAT (7)
#define DOG_GARBAGE_IN_INSTALLING (8)
#define DOG_GARBAGE_IN_INSTALLING_PACKAGE (9)
#define DOG_GARBAGE_IN_INSTALLING_PAWNC (10)
#define DOG_GARBAGE_CURL_COMPILER_TESTING (11)
#define DOG_GARBAGE_COMPILE_N_RUNNING_STAT (12)
